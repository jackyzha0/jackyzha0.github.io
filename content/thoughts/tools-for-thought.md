...
Related: [extended-mind](thoughts/extended-mind.md), [networked-thought](posts/networked-thought.md).
...
Right now, most [organizing systems](thoughts/organizing-systems.md) are really good at 1) and 2) but suck at 3).

We're trying to build tools that allow association between ideas easily, relying on relations and relatedness [without forcing hierarchies or classification straight away](thoughts/articles/city-is-not-a-tree.md). Then, the path through these ideas can be thought of as 'user trails'. 
