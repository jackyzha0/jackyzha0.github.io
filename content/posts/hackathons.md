...
4. We changed judging to be focused on feedback rather than on evaluation. To do so, we replaced exposition judges (who were normally volunteers or company sponsors) with hackers and did [peer-to-peer](thoughts/peer%20to%20peer.md) judging. With this approach, each team averaged 7 pieces of feedback.
