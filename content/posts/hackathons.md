...
Half of our team had been sleeping for the past hour and a bit; acceptable, considering the time was now 2:42 am. The drone was whirring midair in our little room, almost getting snagged on our laptops, chargers, and free event swag. Beside us, the blackboard wall displayed a rough chalk diagram of our technical architecture. We had roughly 20 hours left in the hackathon, and now our biggest roadblock was out of the way — it was time to build! Hastily, we grabbed a plate of cold noodles from the meal line and ran past the crowd of people doing cup stacking competitions, karaoke, and Smash Bros tournaments. This was what the early days of collegiate hackathons felt like to me: the ecstatic energy of people building exciting things with cool people.
...
The congregation of hackers eventually led to the creation of alternative design and hackerspaces like hackathons. These spaces were described as originally being "third spaces" outside of the influence of the state and the capitalist market.[^3] Yet, without intentional intervention, it is difficult for these design spaces to even uphold their liberal rhetoric as spaces for intellectual exploration for all, as they become dominated mostly by the privileged to expend free time and income.

## Neoliberal Cooptation
[i think it'd be cool + reinforce the notion if you concretely gave an example of the first hackathon and maybe referenced the ethos and moved towards "TWILIO API SPONSOR USE OUR 5k CREDITS" kind of deal]
Over time, companies realized that the attendees of these design spaces would *readily* give up their free time to build potentially marketable products. Hackers provided a source of interesting ideas that could be milked, and, as a result, the creative outputs of these hackerspaces were "suddenly highly acclaimed, applied, and copy-pasted into capitalist developing laboratories."[^5]

[I really like these ideas and how you explore it, however there's a bit of a disconnect in how hacker culture (esp on the FCTC side) resulted in the creation of these startups. I'd love one or two more lines (or a paragraph here) on the transition between the two]
The free market has warped the hacker ethos and hackerspaces into something almost unrecognizable from what it was supposed to stand for. Sharon Zukin and Max Papadantonakis in their work *Hackathons as Co-optation Ritual* describe three quasi-Orwellian principles that describe this new hacker culture: Work is Play, Exhaustion is Effervescent, and Precarity is Opportunity.[^1]
...
### Focus on Industry
There seems to be a common sentiment among students that our current school system doesn't prepare students very well for industry. As a result, hackathons have seemingly filled that void. 

[is this preparation just the job fair aspect? you mentioned the sentiment that school doesn't prepare you for industry; how do hackathons fill that void, skills/resume-wise?]
At most hackathons, collegiate, corporate, or otherwise, there is a heavy emphasis on preparing hackers for the workforce. The main hall of most hackathons, reminiscent of a job fair, features an elaborate display of sponsor booths competing for attention. This hiring focus turns hackathons from spaces of discovery, curiosity, and learning into spaces to prepare for the workforce.
...
[just for those who are unfamiliar, give more context on how!]
[eg. Hackathon websites prominently display the total value of prizes available to entice hackers to attend, opening ceremonies primarily feature the project themes required for participants to be eligible for sponsor prizes, etc.]
Increasingly so, hackathons have placed more emphasis on prizes rather than building. Even on DevPost, the 'homepage' for hackathons, hackathons prominently display the prize pool and organize hackathons by how much there is to reap. Who wouldn't want a free iPad and tens of thousands in cash prizes and online subscriptions?
...
If the goal of hackathons is to ultimately encourage people to explore ideas and build new things, prize incentives don't seem to be doing a great job at it. I don't think sponsorship and prize incentives are bad, but I do believe there are better ways to incentivize hackers to learn and build than to provide prizes for the top individuals.
[i'd either rearrange or add a line here that you end up discussing these ways]
...
As it stands, most hackathons projects are unsustainable and are unlikely to be used or continued to be worked on outside of the hackathon. A lot of this practice arises out of the Silicon Valley ethic of "move fast and break things" and "fuck around and find out" attitude. [^7] The problem with this approach is that it becomes incredibly reductionist. Hacks nearly always focus on problems and rarely build on existing community assets. People think hackathons can do things that they usually can't, such as solve global problems, create new products overnight, or 'level the playing field' of innovation through meritocracy.[^3]
[realizing later that you go in-depth about this later but i think it'd still be nice to have a little bit of expansion on what you're missing out on when you're reductionist. what is the alternative?]

Hackathons, as they stand today, seem to optimize for short term excitement, and not so much for long term benefit. Sponsors too, are starting to realize the hackathons don't do much for their hiring pipelines or sales. Maybe this is the [death of modern hackathons](https://jonathanxu.com/blog/2020-07-25-on-hackathons) as we know it, and that might not necessarily be a bad thing.

## Reclaiming Design Spaces
[I'd love to see all this framed from a first-person perspective; telling the reader why you love hackathons and what you've seen happen for u/the people you care about]
[makes it more personal and sweet! at the end of the day, this is still a love letter of some sort]
Despite all my issues with them, I don't think current hackathons are all bad. They give you the chance to meet lots of ridiculously cool people and to learn from each other. The workshops are amazing places to start for beginners and the general atmosphere of a busy evening of hacking is hard to replicate elsewhere. I've personally met a lot of really good friends and mentors through hackathons that I still keep in touch with to this day.
...
* **Hacker-focused spending**. Money spent on often unsustainable swag could be much better spent in favour of more emphasis on higher quality venues, food, and accomodations. In doing so, we can work on raising enough money to run a successful event for the hackers rather than a sponsor's notion of a successful event. At the end of the day, money is power. If you have external funding coming in, the expectation is that they have partial influence over the event. [perhaps from this,, it might be nice to mention having a predetermined line that u refuse to cross for sponsors (in regards to values, morals)]
